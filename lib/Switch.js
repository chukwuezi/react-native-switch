...
export class Switch extends Component {
  ...
  render() {
    ...
    return (
      <TouchableWithoutFeedback onPress={this.handleSwitch} accessibilityLabel={otherProps.accessibilityLabel} testID={otherProps.testID}>
        <Animated.View
            ...
            <Animated.View
              ...
              style={[
                styles.circle,
                {
                  ...
                  borderColor:  circleBorderActiveColor== 'null'?interpolatedCircleBorderColor: circleBorderActiveColor,
